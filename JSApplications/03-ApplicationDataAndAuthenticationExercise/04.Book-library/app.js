...
function handleEdit(e) {
    ...
    formData.set('title', currentTitle.textContent);
    formData.set('author', currentAuthor.textContent);
}
...
function createHtmlBook(book, id) {
    ...
    let editButton = ce('button', undefined, 'Edit');
    editButton.addEventListener('click', handleEdit);
    let deleteButton = ce('button', undefined, 'Delete');
    deleteButton.addEventListener('click', deleteBook);
    let buttonsTd = ce('button', undefined, editButton, deleteButton);
