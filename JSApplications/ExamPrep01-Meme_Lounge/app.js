...
notificationsPage.initialize(page, notificationsRenderHandler);


nav.initialize(page, navRenderHandler, authService);
homePage.initialize(page, appRenderHandler, authService);
loginPage.initialize(page, appRenderHandler, authService, notificationsPage);
registerPage.initialize(page, appRenderHandler, authService, notificationsPage);
allMemesPage.initialize(page, appRenderHandler, memesService);
createPage.initialize(page, appRenderHandler, memesService, notificationsPage);
detailsPage.initialize(page, appRenderHandler, memesService);
editPage.initialize(page, appRenderHandler, memesService, notificationsPage);
