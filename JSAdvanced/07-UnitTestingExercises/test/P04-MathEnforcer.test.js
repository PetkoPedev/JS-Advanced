...
let mathEnforcer = require('../P04-MathEnforcer');
...
describe('mathEnforcer', () => {
    describe('addFive', () => {
        ...
        it('Should return number plus 5 when parameter is a valid number', () => {
    ...
    describe('subtractTen', () => {
        ...
        it('Should return number minus 10 when parameter is a valid number', () => {
