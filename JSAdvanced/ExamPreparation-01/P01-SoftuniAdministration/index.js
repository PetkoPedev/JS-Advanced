function solve() {
    ...
    buttonElement.addEventListener('click', (e) => {
        ...
        if (!lectureNameElement.value || !lectureDateElement.value || !lectureModuleElement.value) {
            return;
        }
        ...
        for (const moduleName in modules) {
            ...
            lectures
                ...
                .forEach(({ name, date }) => {
                    ...
                    let deleteButtonElement = lectureElement.querySelector('button').addEventListener('click', (e) => {
